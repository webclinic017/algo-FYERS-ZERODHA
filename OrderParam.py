...
def OrderParam(strategy_name ,signal):
    ...
    if strategy_name=='3EMA':
        ...
        if signal==1:
            p1 ={'opt':'CE', 'step':-3,'transtype':'BUY','Qty':100}
            p2 ={'opt': 'PE', 'step': -1, 'transtype': 'SELL','Qty': 100}
            OrderPar = {'p1':p1,'p2':p2}
        elif signal==-1:
            p1 = {'opt': 'CE', 'step': 1, 'transtype': 'SELL', 'Qty': 100}
            p2 = {'opt': 'PE', 'step': 3, 'transtype': 'BUY', 'Qty': 100}
